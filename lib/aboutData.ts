...
export const TESTIMONIALS: Testimonial[] = [
  { id: "t1", name: "Arjun Mehta",     role: "JEE Advanced 2026 — AIR 42",         text: "The weekly test review system helped me understand exactly where I was losing marks, not just that I was. That precision changed my preparation completely.",       result: "IIT Bombay — CS",   img:'https://images.pexels.com/photos/31367494/pexels-photo-31367494.jpeg', color: "#0B3C5D" },
  { id: "t2", name: "Priya Sharma",    role: "NEET UG 2026 — 710/720",              text: "After two average attempts elsewhere, Bright Minds gave me a structured system — not just more classes. The doubt sessions were genuinely solved, not postponed.", result: "AIIMS New Delhi",   img:'https://images.pexels.com/photos/32213218/pexels-photo-32213218.jpeg', color: "#27AE60" },
  { id: "t3", name: "Parent of Riya",  role: "CUET 2026 — 98.2 percentile",         text: "Communication from the institute was exemplary. Weekly progress notes, test scores, and attendance — we always knew exactly where Riya stood.",                   result: "DU Economics Hons", img:'https://images.pexels.com/photos/5211478/pexels-photo-5211478.jpeg', color: "#7C3AED" },
  { id: "t4", name: "Karan Singh",     role: "JEE Main 2026 — 99.4 percentile",     text: "I joined as a dropper feeling defeated. The mentorship at Bright Minds restored both my preparation and my confidence. Best decision I made.",                    result: "NIT Trichy",        img:'https://images.pexels.com/photos/5211457/pexels-photo-5211457.jpeg', color: "#0891B2" },
  { id: "t5", name: "Ananya Gupta",    role: "NEET UG 2026 — 695/720",              text: "The 1:1 mentor sessions every fortnight were what separated Bright Minds from every other institute I had attended. Someone was actually tracking my progress.",    result: "MAMC Delhi",        img:'https://images.pexels.com/photos/3985198/pexels-photo-3985198.jpeg ', color: "#DB2777" },
];
