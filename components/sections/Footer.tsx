...
export default function Footer() {
  return (
    <footer className="relative bottom-0 z-0 px-3 pb-0 pt-5 md:px-5">
      <div
        className="sticky mx-auto max-w-[1200px] rounded-t-[32px] px-6 pb-8 pt-10 md:px-10 md:pt-14"
        style={{
          background: "linear-gradient(160deg,#0D1B2A 0%,#082D45 100%)",
        }}
      >
        <div className="grid gap-10 md:grid-cols-[1.4fr_0.6fr_0.6fr_0.8fr]">
          ...
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm leading-7 text-blue-300">
              Premium coaching for Class 9–12, JEE, NEET, and CUET. Structured
              learning, mentored preparation, and real results.
            </p>
            <div className="mt-5 flex flex-col gap-3 text-sm text-blue-300">
              ...
              >
                <Phone size={13} className="text-[#2ECC71]" />
                +91 98765 43210
              </a>
              <a
                href="mailto:hello@brilliantacademy.com"
                className="flex items-center gap-2 transition-colors hover:text-white"
              >
                <Mail size={13} className="text-[#2ECC71]" />
                hello@brilliantacademy.com
              </a>
              <div className="flex items-start gap-2">
                <MapPin size={13} className="mt-0.5 shrink-0 text-[#2ECC71]" />
                <span>D-103, Amar Colony, Lajpat Nagar, New Delhi – 1100024</span>
              </div>
            </div>
          </div>
          {/* Courses */}
          ...
          <div>
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/08 text-blue-300 transition-all hover:bg-white/15 hover:text-white"
                >
                  <Icon size={15} />
                </a>
              ))}
            ...
            <div className="mt-6 rounded-[18px] border border-white/10 bg-white/06 p-4">
              ...
              <p className="mt-1 text-xs font-semibold text-[#F39C12]">
                ★ 4.9 / 5 on Google
              </p>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-white/10 pt-6 md:flex-row">
          <p className="text-xs text-blue-400">
            © 2026 Brilliant Academy. All rights reserved.
          </p>
